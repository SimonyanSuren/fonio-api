// import { Account, User, Company } from "../../models";
...
// import { CompanyInfo } from "../../util/swagger/company_id";
...
//                     "user"."user_email" AS "email", to_char("user"."user_last_login", 'YYYY-MM-DD') AS "last_login", "user"."user_company_name" AS "company_name", "user"."user_id" AS "user_id" , "account"."acco_id" AS "account_id", "account"."acco_status" AS "account_status"
...
//     async createCompany(user, accId, comp: CompanyInfo) {
//         let manager = await this.entityManager;
//         let company = new Company();
//         // company.accountID = accId;
//         company.companyUuid = v4();
//         company.companyName = comp.name;
//         company.userCreatorID = user.userId;
//         company.status = true;
//         company.balance = 0;
//         company.created = new Date();
//         company.userUuid = comp.userUuid;
//         company.timezone = comp.timezone;
